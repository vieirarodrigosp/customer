package br.com.vieirabarbosa.customer.config;
...
public class SwaggerConfig<HttpSecurity> {
	...
	public Docket customerApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("br.com.vieirabarbosa.customer"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("Customer registration microservice")
